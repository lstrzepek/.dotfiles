...
let s:cdFront = {'gui': '#C5C8C6', 'cterm': s:cterm05, 'cterm256': '188'}
let s:cdBack = {'gui': '#1D1F21', 'cterm': s:cterm00, 'cterm256': '234'}
...
let s:cdBlue = {'gui': '#5F819D', 'cterm': s:cterm0D, 'cterm256': '75'}
let s:cdDarkBlue = {'gui': '#223E55', 'cterm': s:cterm0D, 'cterm256': '73'}
let s:cdLightBlue = {'gui': '#81A2BE', 'cterm': s:cterm0C, 'cterm256': '117'}
if g:codedark_conservative | let s:cdLightBlue = s:cdFront | endif
let s:cdGreen = {'gui': '#8C9440', 'cterm': s:cterm0B, 'cterm256': '65'}
let s:cdBlueGreen = {'gui': '#8ABEB7', 'cterm': s:cterm0F, 'cterm256': '43'}
let s:cdLightGreen = {'gui': '#B5CEA8', 'cterm': s:cterm09, 'cterm256': '151'}
let s:cdRed = {'gui': '#A54242', 'cterm': s:cterm08, 'cterm256': '203'}
let s:cdOrange = {'gui': '#DE935F', 'cterm': s:cterm0F, 'cterm256': '173'}
let s:cdLightRed = {'gui': '#CC6666', 'cterm': s:cterm08, 'cterm256': '167'}
if g:codedark_conservative | let s:cdLightRed = s:cdOrange | endif
let s:cdYellowOrange = {'gui': '#A54242', 'cterm': s:cterm0A, 'cterm256': '179'}
let s:cdYellow = {'gui': '#F0C674', 'cterm': s:cterm0A, 'cterm256': '187'}
if g:codedark_conservative | let s:cdYellow = s:cdFront | endif
let s:cdPink = {'gui': '#B294BB', 'cterm': s:cterm0E, 'cterm256': '176'}
if g:codedark_conservative | let s:cdPink = s:cdBlue | endif
let s:cdSilver = {'gui': '#C5C8C6', 'cterm': s:cterm05, 'cterm256': '7'}
